 ...
 * 
 * @param {CardColor} color - The selected color.
 */
...
/**
 * Computed property to determine if the player can challenge the last play.
 * 
 * @returns {boolean} True if the player can challenge, false otherwise.
 */
...
/**
 * Handles the event to start the next hand.
 */
...
<style scoped>
/* Styles for the PlayHand component */
.play-area {
  min-height: 100vh;
